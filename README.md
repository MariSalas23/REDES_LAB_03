...
- **Roles y Contribuciones:**
  * *Nicolás Almonacid (Relator - Programador):* Realización de actas y exportación de configuraciones en archivos TXT - Configuración de la aplicación Tracker.
  * *Juan Pablo Restrepo (Encargado de redes):* Montaje de la topología, configuración del túnel IPsec VPN y del enrutamiento (EIGRP y OSPF).
  * *Mariana Salas (Relatora - Encargada de redes):* Direccionamiento, realización de las tablas y creación de la Wiki - Configuración de VLANs y de los servicios/protocolos de DNS, HTTP, HTTPS, DHCPv6 Stateful, SLAAC, SNMP y ACL. 
